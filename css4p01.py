...
"""
For missing revenue values, it's reasonable to drop the rows as revenue is a key metric, and imputing it may introduce bias.
For missing metascore values, filling with the mean score is a common approach, assuming that the missing values are missing at random.
"""
